...
class LlamaIndexAgent(AgentBase):
    ...
    def reply(self, x: Optional[Union[Msg, Sequence[Msg]]] = None, mem: Optional[Union[str, list[Msg], Msg]] = None, mode: int=None) -> Msg:
        """
        mode:
        0) initilal
        1) strategy
        2) rag
        Random choose several strategies to reponse the last sentence 
